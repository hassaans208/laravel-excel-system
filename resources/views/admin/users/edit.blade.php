...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.users.update', ['user'=> $user]) }}"
            ...
            <div class="form-group">
                <label for="email">{{ trans('cruds.users.fields.email') }}</label>
            ...
            <div class="form-group">
                <label for="password">{{ trans('cruds.users.fields.password') }}</label>
            ...
            <div class="form-group">
                <label for="password_confirmation">{{ trans('cruds.users.fields.password_confirmation') }}</label>
